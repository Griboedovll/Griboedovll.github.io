...
$(window).scroll(function(){
  var li1 = $('#start').offset().top;
  var li2 = $('#our-advantages').offset().top - 100;
  var li3 = $('#characteristics').offset().top - 100;
  var li4 = $('#services').offset().top - 100;
  var li5 = $('#our-company').offset().top - 100;
  var li6 = $('#map').offset().top - 100;
  var li7 = $('#reviews').offset().top - 300;
  ...
  if ($(window).scrollTop() >= li1 && $(window).scrollTop() < li2) {
    $('#li2-menu').removeClass("active");
    $('#li3-menu').removeClass("active");
    $('#li4-menu').removeClass("active");
    $('#li5-menu').removeClass("active");
  ...
  if ($(window).scrollTop() >= li2 && $(window).scrollTop() < li3) {
    $('#li1-menu').removeClass("active");
    $('#li3-menu').removeClass("active");
    $('#li4-menu').removeClass("active");
    $('#li5-menu').removeClass("active");
  ...
  if ($(window).scrollTop() >= li3 && $(window).scrollTop() < li4) {
    $('#li1-menu').removeClass("active");
    $('#li2-menu').removeClass("active");
    $('#li4-menu').removeClass("active");
    $('#li5-menu').removeClass("active");
  ...
  if ($(window).scrollTop() >= li4 && $(window).scrollTop() < li5) {
    $('#li1-menu').removeClass("active");
    $('#li2-menu').removeClass("active");
    $('#li3-menu').removeClass("active");
    $('#li5-menu').removeClass("active");
  ...
  if ($(window).scrollTop() >= li5 && $(window).scrollTop() < li6) {
    $('#li1-menu').removeClass("active");
    $('#li2-menu').removeClass("active");
    $('#li3-menu').removeClass("active");
    $('#li4-menu').removeClass("active");
  ...
  if ($(window).scrollTop() >= li6 && $(window).scrollTop() < li7) {
    $('#li1-menu').removeClass("active");
    $('#li2-menu').removeClass("active");
    $('#li3-menu').removeClass("active");
    $('#li4-menu').removeClass("active");
